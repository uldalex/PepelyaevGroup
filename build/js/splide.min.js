...
! function () {
  ...
  var rt = function (t, n) {
    ...
    lt = function (t, n, e) {
      ...
      function d(n) {
        return y('<button class="' + s.arrow + " " + (n ? s.prev : s.next) + '" type="button"><svg xmlns="http://www.w3.org/2000/svg"\tviewBox="0 0 14 13"\twidth="30"\theight="12"><path d="' + (t.options.arrowPath || " M8.51317 0L7.62231 1.05572L11.5866 5.75351H0.998047L0.998405 7.24654H11.5866L7.62231 11.9443L8.51317 13L13.9984 6.49998L8.51317 0Z") + '" />')
      }
      return {
